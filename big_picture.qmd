...
In the analysis of healthcare spending, the data shows a moderate link between spending and maternal mortality rates. This contradicts the common sense that more money spent on healthcare would lead to better outcomes for younger mothers. There are other many other factors that can affect MMR. 
