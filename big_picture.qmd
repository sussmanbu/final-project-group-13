...
In the exploration of the possible environmental factors to cause this increase in mortality, the scholarly articles that examine the same data gave us the idea to take a close look at the healthcare spending and the average age of pregnancy. The data we found for these variables display these trends: 1. People are having babies later and later in life. 2. People are spending more and more on healthcare. We predict that the maternal mortality ratios will be lower in groups with lower age of pregnancy and higher spending on healthcare. So, a rich and young woman should be a satisfying answer, but is it?
