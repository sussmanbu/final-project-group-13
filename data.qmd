...
### Data Background
These data come from the Institute for Health Metrics and Evaluation and is supported by the Global Health Data Exchange.  It presents maternal mortality ratios for women in the United States from the ages 10-54 for the years 1999-2019. 
...
These data come with multiple data sets, however for our analysis we chose to work with the file US_PER_CAPITA20.CSV in order to view from a summary perspective. The file initially comes with variables Code, Item, Group, Region Number, Region Name, Years 1991-2020, and Average Annual Percent Growth. In the
