...
### Distribution Analysis
```{r, echo=FALSE}
df <- read.csv("dataset/phc_mmr_combined.csv")  # Example of loading data into df instead of data

# Then use df in the ggplot call
ggplot(df, aes(x = spending)) +
  geom_histogram(binwidth = 500,  # Adjust bin width as needed
                 fill = "#69b3a2", 
                 color = "white") +
