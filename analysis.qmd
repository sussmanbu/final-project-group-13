...
Through the following analysis, a clear trend of spending vs mmr and avergae age vs mmr can be identified. 
...
While we were looking at the relationship between healthcare spending and maternal mortality rate, we found out that there may be other factors that influence the mortality rate as their correlation is not strong. In addition, our pregnancy rate data in each state didn’t include specific ethnic groups, thus we cannot correlate them in a detailed way to distinguish the effects of pregnancy rate in each ethnic group on the maternal mortality rate. 


## Conclusion
1.As time passes, the maternal mortality rate increases across the U.S. Non-Hispanic American Indian, Alaska Native and Non-Hispanic Black are the three most vulnerable ethnic groups.

2.Increasing spending on healthcare would decrease the
maternal mortality rate.

3.As the age of pregnant women increases, the maternal mortality rate also increases.
